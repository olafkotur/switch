  ...
  constructor(props: {}) {
    ...
    this.config = [
      ...
      },
      {
        ...
        title: 'Notifications',
        description:
          'All the notifications from your applications are re-directed right through switch onto your desktop.',
      },
      {
        icon: '🍻',
        title: 'Overlay Mode',
      ...
      },
      {
        ...
        description:
          'The platform is built using tools that allow the application to run on all major operating systems.',
      },
      {
        icon: '🙋🏽‍♀️',
        title: 'Feedback',
        description:
          'Everyone has the chance to report bugs and recommend features that are then implemented into Switch.',
      },
      {
        icon: '🙉',
        title: 'Jeeeeeez!',
        description:
          'Switch will work with most web applications, you can choose from our suggested apps or just add your own.',
      },
    ];
      ...
      <div>
        ...
        <div className="mt-5 d-flex flex-column justify-content-center align-items-center">
          ...
          <div className="landing-feature-container mt-3">
            ...
            <div
              className={`d-flex flex-row row overflow-auto mt-4 ${
                this.state.showFullPage ? '' : 'justify-content-center'
              }`}
            >
              {this.config.map((v, i) => (
                <Feature
