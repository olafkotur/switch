    ...
    <PrivacyContainer>
      <PrivacyContent>
        ...
        <MediumText faint>
          ...
          app. Please read this Privacy Policy carefully. By accessing or using the app, you acknowledge that you have
        ...
        <MediumText faint>
          ...
          industry-standard measures to protect them from unauthorized access, disclosure, alteration, or destruction.
          We employ encryption and secure transmission protocols to ensure the confidentiality and integrity of your
          data. Rest assured, we do not store any passwords, cookies, or any personal data used in third-party apps.
        </MediumText>
        <Spacer vertical={10} />
        ...
        <MediumText faint>
          ...
          services or entities. We believe in maintaining strict control over your data to ensure it remains
        ...
        <MediumText faint>
          ...
          information from children under 13. If you are a parent or guardian and believe we have inadvertently
          collected personal information from a child under 13, please contact us immediately, and we will take steps to
        ...
        <MediumText faint>
          ...
          effective upon posting the revised version on our website or within the app. It is your responsibility to
