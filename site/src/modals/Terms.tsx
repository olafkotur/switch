  ...
  return (
    <TermsContainer>
      <TermsContent>
        ...
        <MediumText faint>
          These Terms of Service govern your use of the app. Please read these Terms carefully. By accessing or using
          the app, you acknowledge that you have read, understood, and agree to be bound by the terms and conditions set
        ...
        <Spacer vertical={5} />
        <MediumText faint>
          The app is provided for your personal and non-commercial use. You may only use the app in accordance with
          these Terms and applicable laws and regulations. You are responsible for maintaining the confidentiality of
        ...
        <MediumText faint>
          ...
          the possibility of such damages. This limitation of liability applies to all claims, whether based on
        ...
        <Spacer vertical={5} />
        <MediumText faint>
          Switch reserves the right to modify, suspend, or terminate the app or any part thereof, at any time and for
          any reason, without prior notice. We may also modify these Terms from time to time. It is your responsibility
          to review these Terms periodically for any changes. Continued use of the app after such modifications shall
